    ...
    .Does(() =>
{
   var nuGetPackSettings   = new NuGetPackSettings {
		...
		Files = new[] {
			new NuSpecContent { Source = thisDir + @"Src/EzDbSchema.Core/bin/Release/net47/EzDbSchema.Core.dll", Target = "lib/net47" },
			new NuSpecContent { Source = thisDir + @"Src/EzDbSchema.MsSql/bin/Release/net47/EzDbSchema.MsSql.dll", Target = "lib/net47" },
